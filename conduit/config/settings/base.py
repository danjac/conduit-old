...
MIDDLEWARE = [
    ...
    "conduit.common.turbo.middleware.TurboStreamMiddleware",
    ...
    "conduit.common.middleware.http.HttpResponseNotAllowedMiddleware",
]
...
SOCIALACCOUNT_ADAPTER = "conduit.users.adapters.SocialAccountAdapter"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "conduit.common.context_processors.is_cookies_accepted",
            ],
            "libraries": {"pagination": "conduit.common.pagination.templatetags"},
        },
    }
]
